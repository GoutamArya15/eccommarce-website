            ...
            <div class="order-md-last">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-sm">
                        <div>
                            <small class="my-0"><b>Name</b></small>
                        </div>
                        <div>
                            <small class="my-0"><b>Price</b></small>
                        </div>
                        <div>
                            <small class="my-0"><b>Total Price</b></small>
                        </div>
                    </li>
                    ...
                    @endphp
                        ...
                        @php
                            $total += $item['product']['details']['product_price'] * $item['quantity'];
                        @endphp
                            <li class="list-group-item d-flex justify-content-between lh-sm">
                                <div>
                                ...
                                <span
                                class="text-body-secondary">${{ $item['product']['details']['product_price'] }}</span>
                                <span
                                    class="text-body-secondary">${{ $item['product']['details']['product_price'] * $item['quantity'] }}</span>
                            </li>
                        @endforeach
                    ...
                    <div class="search-bar row bg-light p-2 rounded-4">
                        <div class="col-md-4 d-none d-md-block">
                            <select class="form-select border-0 bg-transparent">
                                <option value="">{!! __('welcome.AllCategory') !!}</option>
                    ...
                    ;
                        ...
                        margin-top: 5px">
                            ...
                            <a class="nav-link dropdown-toggle pe-3" role="button" id="pages"
                                data-bs-toggle="dropdown" aria-expanded="false">{!! __('welcome.Pages') !!}</a>
...
<div class="container-lg">
    <div class="row">
        <div class="col-lg-6 pt-5 mt-5">
            ...
            <p class="fs-4">{!! __('welcome.organic_food_heading') !!}</p>
            <div class="d-flex gap-3">
                <a href="{{route('shop.show')}}"
                    class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">{!! __('welcome.StartShopping') !!}</a>
                <a href="#"
                    class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">{!! __('welcome.JoinNow') !!}</a>
            </div>
            <div class="row my-5">
                <div class="col">
                    <div class="row text-dark">
                        ...
                        <div class="col">
                            <p class="text-uppercase lh-sm mb-0">{!! __('welcome.ProductVarieties') !!}</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="row text-dark">
                        ...
                        <div class="col">
                            <p class="text-uppercase lh-sm mb-0">{!! __('welcome.HappyCustomers') !!}</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="row text-dark">
                        ...
                        <div class="col">
                            <p class="text-uppercase lh-sm mb-0">{!! __('welcome.StoreLocations') !!}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card-body p-0">
                            <h5 class="text-light">{!! __('welcome.FreshFromFarm') !!}</h5>
                            <p class="card-text">{!! __('welcome.lorem') !!}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card border-0 bg-secondary rounded-0 p-4 text-light">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card-body p-0">
                            <h5 class="text-light">{!! __('welcome.100PercentOrganic') !!}</h5>
                            <p class="card-text">{!! __('welcome.lorem') !!}</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col">
            <div class="card border-0 bg-danger rounded-0 p-4 text-light">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card-body p-0">
                            <h5 class="text-light">{!! __('welcome.FreeDelivery') !!}</h5>
                            <p class="card-text">{!! __('welcome.lorem') !!}</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-header d-flex flex-wrap justify-content-between my-4">
                    <h2 class="section-title">{!! __('welcome.BestSellingProducts') !!}</h2>

                    <div class="d-flex align-items-center">
                        <a href="#" class="btn btn-primary rounded-1">{!! __('welcome.ViewAll') !!}</a>
                    </div>
                </div>
                            ...
                            <div class="product-item">
                                <figure>
                                    <a href="index.html" title="Product Title">
                                        <img src="{{ asset('assets/uploads/products/') . '/' . $value['details']['product_image'] }}"
                                ...
                                <div class="d-flex flex-column text-center">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        <del>$24.00</del>
                                        <span
                                            class="text-dark fw-semibold">${{ $value['details']['product_price'] }}</span>
                                        <span
                ...
                <div class="banner-blocks">
                    ...
                    <div class="banner-ad d-flex align-items-center large bg-info block-1"
                        ...
                        <div class="banner-content p-5">
                            <div class="content-wrapper text-light">
                                <h3 class="banner-title text-light">{!! __('welcome.ItemsOnSALE') !!}</h3>
                                <p>{!! __('welcome.DiscountsUpTo30Percent') !!}</p>
                                <a href="#" class="btn-link text-white">{!! __('welcome.ShopNow') !!}</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="banner-ad bg-success-subtle block-2"
                        ...
                        <div class="banner-content align-items-center p-5">
                            <div class="content-wrapper text-light">
                                <h3 class="banner-title text-light">{!! __('welcome.ComboOffers') !!}</h3>
                                <p>{!! __('welcome.DiscountsUpTo30Percent') !!}</p>
                                <a href="#" class="btn-link text-white">{!! __('welcome.ShopNow') !!}</a>
                            </div>
                        </div>
                    ...
                    <div class="banner-ad bg-danger block-3"
                        ...
                        <div class="banner-content align-items-center p-5">
                            <div class="content-wrapper text-light">
                                <h3 class="banner-title text-light">{!! __('welcome.DiscountCoupons') !!}</h3>
                                <p>{!! __('welcome.DiscountCoupons') !!}</p>
                                <a href="#" class="btn-link text-white">{!! __('welcome.ShopNow') !!}</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-header d-flex flex-wrap justify-content-between my-4">
                    ...
                    <h2 class="section-title">{!! __('welcome.FeaturedProducts') !!}</h2>

                    <div class="d-flex align-items-center">
                        <a href="#" class="btn btn-primary me-2">{!! __('welcome.ViewAll') !!}</a>
                ...
                <div class="swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-10.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-11.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-12.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-13.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-14.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-15.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-16.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-17.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                                ...
                                <div class="button-area p-3 pt-0">
                                    <div class="row g-1 mt-2">
                                        <div class="col-3"><input type="number" name="quantity"
                                                class="form-control border-dark-subtle input-number quantity"
                                                value="1"></div>
                                        <div class="col-7"><a href="gdagsdg"
                                                class="btn btn-primary rounded-1 p-2 fs-7 btn-cart"><svg
                                                    width="18" height="18">
                                                    <use xlink:href="#cart"></use>
                                                </svg> Add to Cart</a></div>
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-18.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-5 p-3">
                        <div class="section-header">
                            <h2 class="section-title display-5 text-light">{!! __('welcome.Get25PercentDiscountOnFirstPurchase') !!}
                            </h2>
                        </div>
                        <p>{!! __('welcome.SignUpRegisterNow') !!}</p>
                    </div>
                    <div class="col-md-5 p-3">
                        <form>
                            <div class="mb-3">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-header d-flex justify-content-between my-4">
                    ...
                    <h2 class="section-title">{!! __('welcome.MostPopularProducts') !!}</h2>
                ...
                <div class="swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-19.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-header d-flex justify-content-between my-4">
                    ...
                    <h2 class="section-title">{!! __('welcome.JustArrived') !!}</h2>
                ...
                <div class="swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-20.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-22.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
                        ...
                        <div class="product-item swiper-slide">
                            <figure>
                                <a href="index.html" title="Product Title">
                                    <img src="{{ asset('assets/images/product-thumb-23.png') }}"
                                        alt="Product Thumbnail" class="tab-image">
                                </a>
                            </figure>
                            <div class="d-flex flex-column text-center">
    ...
    <div class="container-lg">
        <div class="row">
            <div class="section-header d-flex align-items-center justify-content-between my-4">
                <h2 class="section-title">{!! __('welcome.OurRecentBlog') !!}</h2>
                <a href="#" class="btn btn-primary">{!! __('welcome.ViewAll') !!}</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
        ...
        <div class="bg-warning pt-5 rounded-5">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-4">
                        <h2 class="mt-5">{!! __('welcome.DownloadOrganicApp') !!}</h2>
                        <p>{!! __('welcome.OnlineOrdersEasyFastReliable') !!}</p>
                        <div class="d-flex gap-2 flex-wrap mb-5">
                            <a href="#" title="App store"><img
                                    src="{{ asset('assets/images/img-app-store.png') }}" alt="app-store"></a>
                            <a href="#" title="Google Play"><img
                                    src="{{ asset('assets/images/img-google-play.png') }}"
                                    alt="google-play"></a>
                        </div>
                    </div>
                    <div class="col-md-5">
...
<section class="py-4">
    <div class="container-lg">
        <h2 class="my-4">{!! __('welcome.PeopleAlsoLookingFor') !!}</h2>
        ...
        <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-5">
            ...
            <div class="col">
                <div class="card mb-3 border border-dark-subtle p-3">
                    ...
                    <div class="card-body p-0">
                        <h5>{!! __('welcome.100PercentOrganic') !!}</h5>
                        <p class="card-text">{!! __('welcome.lorem') !!}</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-3 border border-dark-subtle p-3">
                    ...
                    <div class="card-body p-0">
                        <h5>{!! __('welcome.QualityGuarantee') !!}</h5>
                        <p class="card-text">{!! __('welcome.lorem') !!}</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card mb-3 border border-dark-subtle p-3">
                    ...
                    <div class="card-body p-0">
                        <h5>{!! __('welcome.GuaranteedSavings') !!}</h5>
                        <p class="card-text">{!! __('welcome.lorem') !!}</p>
                    </div>
                </div>
            </div>
...
<footer class="py-5">
    <div class="container-lg">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-6">
                <div class="footer-menu">
                    ...
                    <ul class="menu-list list-unstyled">
                        <li class="menu-item">
                            <a href="#" class="nav-link">{!! __('welcome.AboutUs') !!}</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="nav-link">{!! __('welcome.Conditions') !!}</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="nav-link">{!! __('welcome.OurJournals') !!}</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="nav-link">{!! __('welcome.Careers') !!}</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="nav-link">{!! __('welcome.AffiliateProgramme') !!}</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="nav-link">{!! __('welcome.UltrasPress') !!}</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-2 col-sm-6">
                <div class="footer-menu">
                    <h5 class="widget-title">{!! __('welcome.QuickLinks') !!}</h5>
                    <ul class="menu-list list-unstyled">
                        <li class="menu-item">
            ...
            <div class="col-md-2 col-sm-6">
                <div class="footer-menu">
                    <h5 class="widget-title">{!! __('welcome.CustomerService') !!}</h5>
                    <ul class="menu-list list-unstyled">
                        <li class="menu-item">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer-menu">
                    <h5 class="widget-title">{!! __('welcome.SubscribeUs') !!}</h5>
