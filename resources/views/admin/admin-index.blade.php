  <head>
      ...
      {{-- <link rel="stylesheet" href="assets/vendors/datatables.net-bs5/dataTables.bootstrap5.css{{ asset('') }}"> --}}
      <link rel="stylesheet" href="{{ asset('assets/admin/vendors/ti-icons/css/themify-icons.css') }}">
          ...
          <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
              <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                  <a class="navbar-brand brand-logo me-5" href="index.html"><img
                          src="{{ asset('assets/images/logo.svg') }}" class="me-2" alt="logo" /></a>
              </div>
                  ...
                  <ul class="navbar-nav navbar-nav-right">
                      ...
                      <li class="nav-item nav-profile dropdown">
                          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                              id="profileDropdown">
                              <img s<img src="{{ asset('assets/admin/images/faces/face28.jpg') }}" />
                          </a>
                                      ...
                                      <div class="list-wrapper pt-2">
                                          <ul class="d-flex flex-column-reverse todo-list todo-list-custom">
                                              ...
                                              <li>
                                                  <div class="form-check form-check-flat">
                                                      <label class="form-check-label">
                                                          <input class="checkbox" type="checkbox"> Project meeting
                                                          with CEO </label>
                                                  </div>
                                                  <i class="remove ti-close"></i>
                                              </li>
                                              <li class="completed">
                                                  <div class="form-check form-check-flat">
                                                      <label class="form-check-label">
                                                          <input class="checkbox" type="checkbox" checked> Follow up
                                                          of team zilla </label>
                                                  </div>
                                                  <i class="remove ti-close"></i>
                                              </li>
                              ...
                              <div class="card">
                                  <div class="card-body">
                                      ...
                                      <ul class="icon-data-list">
                                          <li>
                                              <div class="d-flex">
                                                  <img s<img src="{{ asset('assets/admin/images/faces/face1.jpg') }}"
                                                      alt="user">
                                                  <div>
                                          ...
                                          <li>
                                              <div class="d-flex">
                                                  <img s<img src="{{ asset('assets/admin/images/faces/face2.jpg') }}"
                                                      alt="user">
                                                  <div>
                                          ...
                                          <li>
                                              <div class="d-flex">
                                                  <img s<img src="{{ asset('assets/admin/images/faces/face3.jpg') }}"
                                                      alt="user">
                                                  <div>
                                          ...
                                          <li>
                                              <div class="d-flex">
                                                  <img s<img src="{{ asset('assets/admin/images/faces/face4.jpg') }}"
                                                      alt="user">
                                                  <div>
                                          ...
                                          <li>
                                              <div class="d-flex">
                                                  <img s<img src="{{ asset('assets/admin/images/faces/face5.jpg') }}"
                                                      alt="user">
                                                  <div>
